...
def _nav_status_chip(label: str, colour: str) -> str:
    ...
    ``handlers_rd`` imports from this module, so importing back would
    create a cycle. The duplicated XML is small and self-contained.
    """
    return (
...
def _build_prev_next_nav(c: "_Converter") -> str:
