"""Dispatch table for the Confluence converter.

Importing this module populates `converter.HANDLERS` with every
plain-HTML and rd-* handler. Mirrors the md / docx exporters so the
three pipelines stay easy to compare side-by-side.
"""
...
HANDLERS.update({
    ...
    "br": p._h_br,
    "hr": p._h_hr,
    "strong": p._h_inline_tag("strong"),
    "b": p._h_inline_tag("strong"),
    "em": p._h_inline_tag("em"),
    "i": p._h_inline_tag("em"),
    "s": p._h_inline_tag("s"),
    "del": p._h_inline_tag("s"),
    "strike": p._h_inline_tag("s"),
    "u": p._h_inline_tag("u"),
    "mark": p._h_inline_tag("strong"),  # Confluence drops <mark>; bold instead.
    "sup": p._h_inline_tag("sup"),
    "sub": p._h_inline_tag("sub"),
    "small": p._h_inline_tag("small"),
    ...
    "aside": p._h_unwrap,
    "figure": p._h_unwrap,
    "figcaption": p._h_inline_tag("em"),
    "time": p._h_unwrap,
    # head / metadata — drop entirely
    "script": p._h_drop,
    "style": p._h_drop,
    "head": p._h_drop,
    "meta": p._h_drop,
